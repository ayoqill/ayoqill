<div>
  <img style="100%" src="https://capsule-render.vercel.app/api?type=venom&height=90&section=header&reversal=false&text=Helloo&fontSize=70&fontColor=FFFFFF&fontAlign=50&fontAlignY=50&stroke=-&animation=blink&descSize=20&descAlign=50&descAlignY=50&textBg=false&color=gradient"  />
</div>
...
<h6 align="center">Data Science & Computational Intelligence @ IIUM<br><br>A Computer science student interested in data engineering, focusing on data pipelines, data processing, and preparing data for analytics and machine learning. Currently exploring and growing in this field.</h6>
...
💼 LinkedIn: <a href="https://linkedin.com/in/aqilaiman260" target="_blank" rel="noopener noreferrer">linkedin.com/in/aqilaiman260</a><br>
